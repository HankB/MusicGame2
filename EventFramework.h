 ...
 */
 ...
 /*
  * following is stuff added from the test project for this library so it will compile here.
  */

static const bool verbose=false;      // turn on/off verbose crap. Make it const and the compiler is free to optimize away the code
